                        ...
                        unsigned costeTaxi1, unsigned costeTaxi2, vector<typename GrafoP<tCoste>::vertice>& camino)
{
    ...
    for(size_t i = 0; i < superGrafo.numVert(); i++)
        ...
        costeMin = min(min(costesMinTren[destino], costesMinAutobus[destino+n]), costesMinAvion[destino+2*n]);
...
int main(){
    ...
    cout << "\nY el coste minimo para realizar dicho camino teniendo en cuenta los 3 tipos de transbordos es de: " << costeMin << " euros." << endl;
}
